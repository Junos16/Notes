It is important to have granular control over how or who can access objects in S3 buckets to prevent security issues in sensitive data. There are 3 ways in how access to objects can be restricted:
